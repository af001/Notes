...
/**
 * Allows to handle the {@link orangegangsters.lollipin.managers.AppLock} from within
...
public class LockManager<T extends AppLockActivity> {
    ...
    /**
     * The static singleton instance of {@link orangegangsters.lollipin.managers.AppLock}
     */
     ...
     * {@link orangegangsters.lollipin.PinActivity}
     */
    ...
    /**
     * Tells the app if the {@link orangegangsters.lollipin.managers.AppLock} is enabled or not
     */
